    ...
    data() {
        return {
            ...
            service_items: [{
                    ...
                    description: "Semua bisa COD di Komship. Otomatis dan tanpa ribet urus persyaratan kerjasama satu persatu ke ekspedisi.",
                },
                {
                    id: 2,
                    title: "Pencairan Setiap Hari",
                    image: require("@/assets/img/icons/calender.png"),
                    description: "Kamu bisa tarik dana COD kapanpun karena pencairan dapat dilakukan setiap hari.",
                },
                {
                    id: 3,
                    title: "Lebih Hemat",
                    image: require("@/assets/img/icons/analyst-icon.png"),
                    description: "Dapatkan diskon ongkos kirim MULAI dari 25% (Berlaku COD dan Non COD) lebih hemat dibandingkan yang lain.",
                },
                {
                    id: 4,
                ...
                },
                {
                    ...
                    description: "Cukup tunggu saja di rumah, kurir akan mendatangi lokasimu untuk mengambil paket TANPA MINIMUM ORDER.",
                },
            ],
            flow_items: [{
                    id: 1,
            ...
            feature_items: [{
                    ...
                    description: "Jika kamu memiliki produk dengan variasi yang berbeda, maka fitur produk terlaris ini dapat membantu kamu mengetahui produk mana yang menjadi best seller dalam kurun waktu 1 bulan atau 7 hari terakhir.",
                    image: require("@/assets/img/partials/produk-terlaris.svg"),
                },
                {
                    id: 2,
                    title: "Customer Loyal",
                    description: "Merupakan data Customer yang sering melakukan order kembali (repeat order). Dengan mengetahui Customer Loyal kita, maka proses orderan akan semakin cepat.",
                    image: require("@/assets/img/partials/customer-loyal.svg"),
                },
                {
                    id: 3,
                    title: "Produk Terlaris",
                    description: "Fitur yang akan mempermudah para pebisnis memantau produktifitas para admin dengan melihat data akumulasi performa masing-masing admin yang ada. Makin mudah juga untuk mengambil keputusan seperti pemberian bonus dan meningkatkan semangat kerja para admin.",
            ...
            testimoni_items: [{
                ...
                },
                {
                    ...
                    description: "Alhamdulilah lancar , fiturnya mudah di pahami juga. Apalagi, Kalau ada kendala team Komship siap membantu dan fast respon. Pemakaiannya juga simple, beda sama Aplikasi serupa yang lain.",
                },
                {
                    id: 6,
