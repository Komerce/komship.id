  ...
  <v-app>
    <section class="terms">
      <div class="container">
        ...
        <h5>1. DEFINISI</h5>
        <p>
          1.1 "Kami" : Adalah PT. Kampung Marketerindo Berdaya selaku pemilik
          Komerce dan pengelola platform Komship<br />
          1.2 "Anda" : Adalah orang yang mengakses situs atau pengguna platform
          Komship<br />
        ...
        <p>
          ...
          berlaku.<br />
          2.4 Pengguna jasa dan situs Komship tidak diperkenankan untuk
          menggunakan situs dan/atau aplikasi untuk tindakan yang menganggu atau
          melanggar hak orang lain.<br />
        ...
        <p>
          4.1 Komship berhak untuk merubah kebijakan di kemudian hari tanpa
          persetujuan pihak lain.<br />
          4.2 Syarat-syarat yang tidak tertulis dalam dokumen ini bersifat
